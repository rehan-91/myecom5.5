       ...
       <div class="panel-footer">
         ...
         <div class="col-md-4">
          ...
          <div class="panel panel-default">
           ...
           <a href="{{route('paymentCard')}}" class="btn btn-warning btn-lg btn-block">Credit Card</a>
            <a href="{{route('cashonDelivery')}}" class="btn btn-warning btn-lg btn-block" style="background-color: #337AB7">Cash On Delivery</a>
        </div> <!-- col md 4 --> 
      </div>
    </div> <!-- container -->
